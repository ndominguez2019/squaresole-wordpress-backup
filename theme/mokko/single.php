	...
	<article class="ms-sp--article">
		<div class="entry-content">
			<?php while ( have_posts() ) : the_post();
				the_content( sprintf( __( 'Continue reading %s', 'mokko' ), the_title( '<span class="screen-reader-text">', '</span>', false ) ) );
				mokko_link_pages();
			endwhile; ?>
		</div>
	</article>
