...
if ( '0' === $comment->comment_approved ) { ?>
	...
	<p class="meta">
		<em class="woocommerce-review__awaiting-approval">
			<?php esc_html_e( 'Your review is awaiting approval', 'mokko' ); ?>
		</em>
	</p>

<?php } else { ?>

	<div class="ms-review-meta meta">
		<div class="ms-review-meta__name">
			<strong class="woocommerce-review__author"><?php comment_author(); ?> </strong>
			<?php
			if ( 'yes' === get_option( 'woocommerce_review_rating_verification_label' ) && $verified ) {
				echo '<em class="woocommerce-review__verified verified">(' . esc_attr__( 'verified owner', 'mokko' ) . ')</em> ';
			}

			?>
		</div>
		<div class="ms-review-meta__time">
